...
?>
    ...
    <input type="text" name="cpf" id="" value=<?php echo $cpf?> class="confignome" >
     ...
     <select type="text" name="estatus" id="" value=<?php echo $estatus?> placeholder="Informe seu status (AP ou RP)" class="enderecoenascimento" >
    ...
    <a class="botao2" href="listaprofessores.php">Verificar alunos cadastrados</a>
